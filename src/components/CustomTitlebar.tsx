    ...
    >
      ...
      <div className="flex items-center pr-5 gap-3 tauri-no-drag">
        ...
        <div className="flex items-center gap-1">
          ...
          {onUsageClick && (
            <TooltipSimple content={t('navigation.usage_dashboard')} side="bottom">
              <motion.button
        ...
        <div className="flex items-center gap-1">
          {onSettingsClick && (
            <TooltipSimple content={t('actions.settings')} side="bottom">
              <motion.button
          ...
          <div className="relative" ref={dropdownRef}>
            <TooltipSimple content={t('actions.more_options')} side="bottom">
              <motion.button
